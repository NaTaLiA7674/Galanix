...
def mostrar_footer():
    global salir, archivos, google, label_footer, calculadora  # Agregar referencias globales
    ...
    salir_boton = Button(footer_frame, image=salir, bg="#61677A")
    ...
    archivos_boton = Button(footer_frame, image=archivos, bg="#61677A")
...
def mostrar_widgets():
    ...
    archivos_boton = Button(ventana, image=archivos_ventana, text='Archivos', bg="#61677A", compound="top", fg="white")
